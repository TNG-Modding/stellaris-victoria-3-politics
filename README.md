...
- Install python
- `git clone https://github.com/TNG-Modding/paradox-gamefiles-templatemaker`
...
- `git clone https://github.com/TNG-Modding/stellaris_victoria_3_politics`
- `cd ./stellaris_victoria_3_politics/zintemplator`
